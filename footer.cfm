...
<div class="listShowDiv mt-5">
    <div class="listShowDivOne">
        ...
        <div class="text-1 fs-15 text-white">List your Show</div>
        <div class=" footer-text-2  ps-3 fs-15" >Got a show, event, activity or a great experience? Partner with us & get listed on BookMyShow</div>
        <a href="" class="contactToday ms-5">Contact today!</a>
    </div>
</div>
