...
<html lang="en">
    ...
    <body>
        <div class="bzTJkU mt-5">
            <div class="iUglyZ">
                <div class="fDqlDq">
                    <img alt="hut" src="assests/hut.svg" class=" gipVVh">
                </div>
                <div class="jwUOBP fs-15">List your Show

                </div>
                <div class=" jNUTAs fs-15" >Got a show, event, activity or a great experience? Partner with us &amp; get listed on BookMyShow

                </div>
                <a href="/list-your-show" class="ctrgkd">Contact today!</a>
            </div>
        </div>


        <div class="bwc__sc-au4qa5-39 iaUPsu">
            <div class="bwc__sc-au4qa5-40 igiRIk"> </div>
            <a href="/" class="bwc__sc-au4qa5-41 LFerV">
                <img alt="bookmyshow" src="//in.bmscdn.com/webin/common/icons/logo.svg">
            </a>
            <div class="bwc__sc-au4qa5-40 igiRIk">  </div>
        </div>

        <div class="bwc__sc-au4qa5-28 dtUDzi">
            <a href="https://www.facebook.com/BookMyShowIN" class="bwc__sc-au4qa5-29 hOLPST">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 98 98"><path d="M48 .5C21.8.5.5 21.8.5 48S21.8 95.5 48 95.5 95.5 74.2 95.5 48 74.2.5 48 .5zm11.8 49.2h-7.7v27.5H40.6V49.7h-5.4V40h5.4v-6.3c0-4.5 2.1-11.6 11.6-11.6h8.5v9.4h-6.2c-1 0-2.4.5-2.4 2.7v5.7h8.7l-1 9.8z"></path>
                </svg>
            </a>
            <a href="https://twitter.com/BookMyShow/" class="bwc__sc-au4qa5-29 hOLPST">
            ...
            <a href="https://www.instagram.com/bookmyshowin/" class="bwc__sc-au4qa5-29 hOLPST">
            ...
            <a href="https://www.youtube.com/user/BookMyShow/featured" class="bwc__sc-au4qa5-29 hOLPST">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 102 102">
            ...
            <a href="https://www.pinterest.com/bookmyshow/" class="bwc__sc-au4qa5-29 hOLPST">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 102 102">
            ...
            <a href="https://www.linkedin.com/company/bookmyshow/" class="bwc__sc-au4qa5-29 hOLPST">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 102 102">
        ...
        <div class="bwc__sc-au4qa5-27 eOLamZ">Copyright <!-- -->2023<!-- --> © Bigtree Entertainment Pvt. Ltd. All Rights Reserved.<br>The content and images used on this site are copyright protected and copyrights vests with the respective owners. The usage of the content and images on this website is intended to promote the works and no endorsement of the artist shall be implied. Unauthorized use is prohibited and punishable by law.</div>
