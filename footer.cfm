    ...
    <body>
        <div class="listShowDiv mt-5">
            <div class="listShowDivOne">
                <div class="iconDiv">
                    <img alt="hut" src="assests/hut.svg" class="icon">
                </div>
                <div class="text-1 fs-15 text-white">List your Show

                </div>
                <div class=" footer-text-2  ps-3 fs-15" >Got a show, event, activity or a great experience? Partner with us &amp; get listed on BookMyShow

                </div>
                <a href="/list-your-show" class="contactToday ms-5">Contact today!</a>
            </div>
        </div>
        ...
        <div class=" footerText">Copyright <!-- -->2023<!-- --> © Bigtree Entertainment Pvt. Ltd. All Rights Reserved.<br>The content and images used on this site are copyright protected and copyrights vests with the respective owners. The usage of the content and images on this website is intended to promote the works and no endorsement of the artist shall be implied. Unauthorized use is prohibited and punishable by law.</div>
