    ...
    <div class="nav-bar d-flex justify-content-evenly">
        ...
        <div class="d-flex">
            ...
            <div class="d-flex">
                ...
                <input  class="mt-2 ms-4" type="submit" id="sign-in" value="Sign in">
